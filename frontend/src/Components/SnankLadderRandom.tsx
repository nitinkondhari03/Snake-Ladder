...
const hadlevalue1=(value1:number)=>{
  ...
  return (
    ...
    <h1 style={{color:"Coral",fontSize:"40px",fontWeight:"bold"}}>{"YOU"}</h1>
    {count==0 &&<Dice size={150} onRoll={(value) => hadlevalue(value)} />
      }
      {playername=="Player 1"&& <h1 style={{color:"Coral",fontSize:"20px",fontWeight:"bold"}}>Last Roll is {rollnumber}</h1>}
      {playername=="Player 2"&& <Dice  size={150} onRoll={(value) => hadlevalue(value)} />}
 ...
 <div style={{margin:"auto"}}>
 <h1 style={{color:"Coral",fontSize:"40px",fontWeight:"bold"}}>{"BOT"}</h1>
    {playername=="Player 1"&& <Dice  size={150} onRoll={(value) => hadlevalue(value)} />}
   
   {playername=="Player 2"&& <h1  style={{color:"Coral",fontSize:"20px",fontWeight:"bold"}}>Last Roll is {rollnumber}</h1>}
<h1>{winner}</h1>
    </div>
    </div>:
...
export default SnankLadderRandom;
